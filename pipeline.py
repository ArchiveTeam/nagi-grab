...
LUA_SHA1 = get_hash(os.path.join(CWD, 'nagi.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--warc-header', 'nagi-dld-script-version: ' + VERSION,
            '--warc-header', ItemInterpolation('nagi-item: %(item_name)s'),
        ...
        if item_type == 'photo':
            wget_args.extend(['--warc-header', 'nagi-photo: ' + item_value.split('/')[1]])
            wget_args.append('http://nagi.ee/photos/'+item_value)
        else:
